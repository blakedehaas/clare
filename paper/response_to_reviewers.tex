...
\filledresponse{We thank the reviewer for highlighting the empirical plasmasphere electron temperature model of Kutiev et al. (2002, doi:10.1029/2002JA009494). We implemented equations (1)--(2) with the average coefficients in Tables 2--3 and restrict evaluation to the published altitude, $L$-shell, and day/night domains. Quantitative results will be inserted after rerunning this corrected implementation on the held-out datasets.}
