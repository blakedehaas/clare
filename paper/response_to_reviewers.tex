...
\filledresponse{We thank the reviewer for highlighting the empirical plasmasphere electron temperature model of Kutiev et al. (2002, doi:10.1029/2002JA009494). We implemented equations (1)--(2) with the average coefficients in Tables 2--3. On the 2,800 \texttt{test-storm} samples within the unambiguous numerical domain of the printed parameterization (1,000--6,370\,km, $L\leq3$, $|\mathrm{glat}|\leq70^\circ$, and the published day/night sectors), Kutiev achieves $R^2=0.1434$, RMSE $=2,052.95$\,K, MAE $=1,576.06$\,K, and 25.21\% accuracy within 10\%. This fixed subset is determined exclusively by the published model domain, not by observed performance. For transparency, we also evaluated a forced extrapolation on all 4,200 storm samples; it yields $R^2=-1.156\times10^7$ and RMSE $=9.354\times10^6$\,K because the $L^5$ term diverges outside the fitted $L\leq3$ region. We report that value only as a sensitivity check and do not treat it as the Kutiev benchmark.}
