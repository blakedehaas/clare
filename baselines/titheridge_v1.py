...
# Load dataset
ds = datasets.load_from_disk(os.path.join(os.path.dirname(__file__), '..', 'dataset', 'output_dataset', 'test-storm'))
...
ds.save_to_disk(os.path.join(os.path.dirname(__file__), '..', 'dataset', 'output_dataset', 'test-storm-baseline-v1-diurnal-filtered-ready'))