...
ds = datasets.load_from_disk('/home/michael/auroral-precipitation-ml/dataset/output_dataset/test-storm-baseline-v1-ready')
...
# Save the plot
plt.savefig(f'../checkpoints/titheridge_storm_v1_plot.png')
...
plt.tight_layout()
plt.savefig(f'../checkpoints/titheridge_storm_v1_deviation_plot.png', dpi=300)
plt.close()