...
ds = datasets.load_from_disk(os.path.join(os.path.dirname(__file__), '..', 'dataset', 'output_dataset', 'test-normal'))
...
ds.save_to_disk(os.path.join(os.path.dirname(__file__), '..', 'dataset', 'output_dataset', 'test-normal-baseline-v2-ready'))