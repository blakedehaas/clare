...
output_columns = ['Te1']
train_path = "data/akebono_solar_combined_v7_chu_train_non_solar_only"
...
solar_ds = datasets.Dataset.load_from_disk("data/akebono_solar_combined_v7_chu_train_solar_only")
val_ds = datasets.Dataset.load_from_disk("data/akebono_solar_combined_v7_chu_test_max_Te_same_timestamp")

train_ds = train_ds.remove_columns(['DateTimeFormatted', 'Ne1', 'Pv1', 'Te2', 'Ne2', 'Pv2', 'Te3', 'Ne3', 'Pv3', 'I1', 'I2', 'I3'])
solar_ds = solar_ds.remove_columns(['DateTimeFormatted', 'Ne1', 'Pv1', 'Te2', 'Ne2', 'Pv2', 'Te3', 'Ne3', 'Pv3', 'I1', 'I2', 'I3'])
...
solar_ds = utils.normalize_ds(solar_ds, means, stds, columns_to_normalize, normalize_output=False)
...
solar_ds = solar_ds.map(convert_to_tensor, num_proc=os.cpu_count(), remove_columns=all_columns)
val_ds.set_format(type="torch")
train_ds.set_format(type="torch")
solar_ds.set_format(type="torch")

actual_train_ds = utils.SamplingDataset([train_ds, solar_ds], [0.5, 0.5], batch_size=batch_size)
train_loader = DataLoader(actual_train_ds, batch_size=batch_size, shuffle=True, num_workers=1)
