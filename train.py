...
train_path = "dataset/processed_dataset_blocksplit_s0/train_chunks"
train_datasets = []
...
val_ds = datasets.Dataset.load_from_disk("dataset/processed_dataset_blocksplit_s0/val-blocks")
