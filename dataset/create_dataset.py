...
for i in tqdm(range(num_chunks)):
    ...
    dataset.save_to_disk(
        f'../data/akebono_solar_combined_v5_experimental_train/chunk_{i:03d}',
        num_shards=1
    )
...
val_dataset.save_to_disk('../data/akebono_solar_combined_v5_experimental_val')
test_dataset.save_to_disk('../data/akebono_solar_combined_v5_experimental_test')
